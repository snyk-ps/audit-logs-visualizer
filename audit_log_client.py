...
class AuditLogClient:
    ...
    def query_audit_logs(
        ...
        if query_type == "org":
            url = f"{self.base_url}/orgs/{query_id}/audit_logs/search?version=2024-10-15"
        elif query_type == "group":
            url = f"{self.base_url}/groups/{query_id}/audit_logs/search?version=2024-10-15"
        else:
            raise ValueError("Invalid query_type. Must be 'org' or 'group'.")
